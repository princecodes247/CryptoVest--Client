...
var cccTheme = {
  ...
  Header: { background: "#ffb400", color: "#fff", displayFollowers: false },
  Followers: {
    background: "#f36b05",
    color: "#fed17b",
    borderColor: "#f36b05",
  ...
  Data: { priceColor: "#fff", infoLabelColor: "#fff", infoValueColor: "#fff" },
  Chart: { fillColor: "#f78715", borderColor: "#fed785" },
  Trend: { colorUnchanged: "#fcc671" },
